...
function sp.revert_overhaul(what, echoback)
  ...
  if sp_config.stance_actionlevel.head < 100 then
    enableoverhaul("damagedleftarm", echoback)
    enableoverhaul("damagedrightarm", echoback)
    enableoverhaul("damagedleftleg", echoback)
    enableoverhaul("damagedrightleg", echoback)
    enableoverhaul("mutilatedleftarm", echoback)
    enableoverhaul("mutilatedleftleg", echoback)
    enableoverhaul("mutilatedrightarm", echoback)
    enableoverhaul("mutilatedrightleg", echoback)
    enableoverhaul("damagedskull", echoback)
  ...
  elseif sp_config.stance_actionlevel.head > 100 then
    disableoverhaul("damagedleftarm", echoback)
    disableoverhaul("damagedrightarm", echoback)
    disableoverhaul("damagedleftleg", echoback)
    disableoverhaul("damagedrightleg", echoback)
    disableoverhaul("mutilatedleftarm", echoback)
    disableoverhaul("mutilatedleftleg", echoback)
    disableoverhaul("mutilatedrightarm", echoback)
    disableoverhaul("mutilatedrightleg", echoback)
    disableoverhaul("damagedskull", echoback)
