...
function valid.hemorrhaging()
 if not (affs.stun or affs.sleep or affs.aeon or affs.sap) then
  sendAll("show bleeding", "show bruising", false)
 end
end
